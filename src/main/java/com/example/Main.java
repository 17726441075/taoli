...
@Service
class TaoliService {
    private List<Taoli> qiqiList = null ;
    ...
    public void qiqi() throws Exception{
                    ...
                    for(var enA:a.getValue().entrySet())
                        if(b.getValue().containsKey(enA.getKey())){
                            ...
                            Taoli x = Taoli.builder()
                                           .coin(coin)
                                           .longExchange(a.getKey().name())
                                           .shortExchange(b.getKey().name())
        ...
        stringRedisTemplate.opsForValue().set("qiqi", JSON.toJSONString(qiqiList));                
    }
